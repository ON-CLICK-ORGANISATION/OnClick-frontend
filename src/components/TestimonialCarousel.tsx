...
const testimonials = [
  {
    ...
    name: 'Elisa Woroniak',
    position: 'Fondatrice',
    text: 'Only Clik a transformé notre présence en ligne. En seulement 3 mois, notre trafic a augmenté de 150% et nos conversions ont doublé. Une équipe à l\'écoute et des résultats concrets.',
    rating: 5,
    image: '/images/testimonials/elisa-woroniak.jpg',
  },
  {
    id: 2,
    name: 'Clément Bergé',
    ...
    rating: 5,
    image: '/images/testimonials/clement-berge.jpg',
  },
  {
    id: 3,
    name: 'Myriam Laurent',
    ...
    rating: 5,
    image: '/images/testimonials/myriam-laurent.jpg',
  },
  {
    id: 4,
    name: 'Jean Renard',
    ...
    rating: 5,
    image: '/images/testimonials/jean-renard.jpg',
  },
]
      ...
      <div className="container-fluid px-4 sm:px-6 lg:px-12 max-w-5xl mx-auto">
        ...
        <div className="p-4 sm:p-8 lg:p-10">
          ...
          <div className="flex items-center justify-center gap-4 mt-8 pt-6 border-t border-[#E2E8F0]">
            ...
            <button
              onClick={prevSlide}
              className="w-10 h-10 rounded-full border-2 border-[#00B4D8] hover:bg-[#00B4D8] hover:text-white transition-all duration-300 flex items-center justify-center text-[#00B4D8] hover:shadow-lg group"
              ...
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`h-1 rounded-full transition-all duration-300 ${
                    index === currentIndex
                      ? 'w-8 bg-[#00B4D8]'
                      : 'w-4 bg-[#E2E8F0] hover:bg-[#00B4D8]/50'
                  }`}
