  ...
  return (
    <section className="bg-white pt-2 pb-2 sm:pt-3 sm:pb-3">
      <div className="container-page">
        <div className="overflow-hidden rounded-[2rem] bg-[#17243b] text-white shadow-2xl">
            ...
            <div className="p-8 sm:p-12 lg:p-14">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="flex size-14 items-center justify-center rounded-full border border-primary/40 bg-primary/10 text-primary"
                >
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <p className="mt-6 max-w-xl text-sm leading-7 text-white/70 sm:text-base">{active.text}</p>
                </motion.div>
              </AnimatePresence>
            </div>

            <div className="hidden min-h-[440px] items-center justify-center bg-gradient-to-br from-[#24435f] via-[#203750] to-[#17243b] p-12 lg:flex">
              <div className="relative h-[290px] w-full max-w-md">
                ...
                <div className="absolute left-1/2 top-1/2 flex size-32 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-white/[0.06] ring-1 ring-white/10">
