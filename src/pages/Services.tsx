      ...
      <section className="bg-[#F7FAFC] py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid gap-10 md:grid-cols-2">
            <h2 className="font-display text-3xl sm:text-4xl font-semibold text-[#1E293B] leading-tight">
              Des services pensés pour accélérer votre croissance
            </h2>
            <div className="space-y-5 text-sm leading-relaxed text-[#64748B]">
              <p>
              ...
              <p>
                OnlyCloz vous accompagne avec une stratégie claire et des solutions digitales conçues pour attirer
      ...
      <section className="py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-semibold text-[#1E293B] leading-tight mb-8">
