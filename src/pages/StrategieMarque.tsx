        ...
        <div className="container-page grid items-center gap-10 py-16 sm:py-20 md:grid-cols-2 md:py-24">
          <div>
            ...
            <p className="mt-6 max-w-md text-sm sm:text-base leading-relaxed opacity-80">
              Une marque ne se résume pas à un logo. C'est une promesse faite à vos clients, qui doit se retrouver
              dans chaque message, chaque visuel et chaque interaction.
            </p>
            <p className="mt-4 max-w-md text-sm sm:text-base leading-relaxed opacity-80">
              Chez OnlyClik, nous construisons votre identité de marque à partir d'une réflexion stratégique et
              d'une bonne compréhension de votre marché, de vos clients et de vos objectifs. Nous définissons votre
              positionnement, votre identité visuelle et les codes qui permettront à votre entreprise d'être
              immédiatement reconnaissable.
            </p>
            <p className="mt-4 max-w-md text-sm sm:text-base leading-relaxed opacity-80">
              Notre objectif : créer des marques cohérentes, mémorables et durables, capables de rester pertinentes
              bien au-delà de leur lancement.
            </p>
            <Link
      ...
      <section className="py-20 sm:py-24">
        <div className="container-page mx-auto max-w-2xl text-center">
          ...
          <p className="mt-5 text-sm sm:text-base leading-relaxed text-foreground/80">
            Découvrez nos services de stratégie de marque, d'identité et de création. Chez OnlyClik, nous
